...
import styles from './customer-component-style'
...
class CustomerComponent extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  renderRow = ({ item ,index}) =>{
    return (
      <TouchableOpacity onPress={()=>this.props.customer(item)}>
  ...
  render() {
      console.tron.log('this.pro', this.props)
    return (
