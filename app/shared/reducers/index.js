...
export const reducers = combineReducers({
  ...
  order: require('../reducers/order.reducer').reducer,
  attendences: require('../../modules/entities/attendance/attendence.reducer').reducer,
  table: require('../../modules/entities/table/table-redux').reducer,
